...
class DrawShapeToolCircularStairsExtensionPage : public DrawShapeToolExtensionPage
{
public:
  explicit DrawShapeToolCircularStairsExtensionPage(
    MapDocument& document, ShapeParameters& parameters, QWidget* parent = nullptr);
...
class DrawShapeToolCircularStairsExtension : public DrawShapeToolExtension
{
public:
  explicit DrawShapeToolCircularStairsExtension(MapDocument& document);
